...
\begin{figure}[t!]
  \centering
   ...
   {\label{fig:iso0}	   
   \includegraphics[height=0.3\textwidth]{figs/shockCubeIso0.jpg}}%
   \:
   \subfigure[Density (at t=0.5s). 7036 blocks.]
   {\label{fig:iso3}	   
   \includegraphics[height=0.3\textwidth]{figs/shockCubeIso3.jpg}}%
	\:
	\subfigure[Initial density (t=0s) obtained after 6 initial refinements. 1089 blocks. ]
   {\label{fig:Aniso0}	   
   \includegraphics[height=0.3\textwidth]{figs/shockCubeAniso0.jpg}}%
   \:
	\subfigure[Density (at t=0.5s). 5522 blocks]
   {\label{fig:Aniso3}	   
   \includegraphics[height=0.3\textwidth]{figs/shockCubeAniso3.jpg}}%
   \caption{Differences between the isotropic and anisotropic AMR on a shockcube problem. Initial conditions have large density jumps between left and right states: 1 block = 8x8x8 cells. [Freret and Groth: 2015] \cite{Freret:2015} } 
\label{fig:isoAniso}      
\end{figure}  
