...
(no refinement, 1 mesh level)]
   {\label{fig:2msflame}	   
   \includegraphics[height=0.25\textwidth, trim=0.2cm 0.2cm 0.2cm .2cm,clip=true]{figs/fsd2_0ms.png}}%
	\:
	\subfigure[At t=4.25ms 5595 (8x8x8) blocks, ~2.8 million cells
(3 levels of mesh refinement)]
   {\label{fig:4msflame}	   
   \includegraphics[height=0.25\textwidth, trim=0.2cm 0.2cm 0.2cm .2cm,clip=true]{figs/fsd4_25ms.png}}%
   \:
	\subfigure[At 7.0 ms, 18531 (8x8x8) blocks, ~9.5 million cells
(3 levels of mesh refinement)]
   {\label{fig:7msflame}	   
   \includegraphics[height=0.25\textwidth, trim=0.2cm 0.2cm 0.2cm .2cm,clip=true]{figs/fsd7_0ms.png}}%
